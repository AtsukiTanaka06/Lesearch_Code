//------------------ グローバル変数 ------------------//
// 定型分析のタイプ
const TYPE = 'general-analysis-name'
// タブボタンname
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        for (let i=0; i<btn.length; i++){
            ...
            btn[i].addEventListener('click', function(){
                ...
                var attr_btn
                if (analysis_type=='顧客属性'){
                    attr_btn = getCheckedBtn(ATTR_BTN)
                }
                else{
                    attr_btn = ['', '']
                }
                ...
                // 月毎
                    ...
                    var json_id = year_btn[1] + '_' + month_btn[1] + '_' + attr_btn[1]
                }
                // %表示
                ...
                // グラフ関数を呼ぶ
                /*
                今のところ表示単位、分母、基準日時のボタンを押してもグラフ表示なし
                */
                if (btn_name==DISP_UNIT_BTN || btn_name==DENOM_BTN || btn_name==DAY_SELECT_BTN){
